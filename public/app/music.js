...
(function () {
  ...
  /* Слова шага «Музыка». Тон тот же, что во всей студии: коротко и по делу,
     без «волн», «катушек» и прочей кухни — пара выбирает песню и место, с
     которого её услышат гости. */
  const WORDS = {
    uz: {
      providers: { youtube: 'YouTube', upload: 'Mening musiqam', nvate: 'nVate', audius: 'Audius' },
      searchPh: 'Qo‘shiq yoki ijrochi…', clear: 'Tozalash',
      ...
      ytPromptTitle: 'YouTube’dan qidiring', ytPromptText: 'Qo‘shiq yoki ijrochi nomini yozing — avval tinglaysiz, keyin tanlaysiz',
      mineEmptyTitle: 'Hozircha bo‘sh', mineEmptyText: 'Havola qo‘ying, fayl yuklang yoki qo‘shiqni botga yuboring',
      errorTitle: 'Qo‘shiqlar ochilmadi', errorText: 'Aloqani tekshirib, qayta urinib ko‘ring',
      trackError: 'Bu qo‘shiq ochilmadi — boshqasini tanlang', tapVideo: 'Tinglash uchun videoga bosing',
      startLabel: 'Qayerdan boshlanadi', startHint: 'Tasmani suring — mehmonlar qo‘shiqni shu yerdan eshitadi',
      playFrom: 'Shu yerdan tinglash',
      top: 'Ko‘pchilik shu yerdan boshlaydi', startSlider: 'Boshlanish vaqti',
      nudge: (d) => `${Math.abs(d)} soniya ${d < 0 ? 'oldinroq' : 'keyinroq'}`, waveCooking: 'Qo‘shiq o‘qilmoqda',
      startsAt: (time) => `${time} dan boshlanadi`, fromStart: 'Boshidan boshlanadi',
      chosen: 'Tanlangan qo‘shiq', change: 'Boshqasini tanlash', remove: 'Musiqani olib tashlash',
      skip: 'Musiqasiz davom etish',
      topTitle: 'nVate’da ko‘p tanlanadi', topText: 'Juftliklar taklifnomasiga qo‘ygan qo‘shiqlar',
      uses: (n) => `${n} marta tanlangan`,
      magicTitle: 'Havoladan olish', magicText: 'YouTube, TikTok, Instagram yoki boshqa havolani qo‘ying — musiqasini o‘zimiz ajratamiz',
      linkPh: 'Havolani shu yerga qo‘ying', paste: 'Qo‘yish', importGo: 'Olish', importOff: 'Hozir ishlamayapti',
      ...
      errors: {
        link: 'Havola o‘qilmadi', unsupported: 'Bu saytdan musiqa olib bo‘lmaydi',
        ...
        noaudio: 'Bu videoda ovoz yo‘q', format: 'Bu fayl o‘qilmadi', timeout: 'Juda uzoq davom etdi — qayta urinib ko‘ring',
        busy: 'Hozir navbat katta — birozdan keyin urinib ko‘ring', unavailable: 'Hozir ishlamayapti', auth: 'Studiyani bot orqali oching',
        failed: 'Musiqa ajratilmadi',
      },
    },
    ru: {
      ...
      errorTitle: 'Песни не загрузились', errorText: 'Проверьте связь и попробуйте ещё раз',
      trackError: 'Эта песня не открылась — выберите другую', tapVideo: 'Нажмите на видео, чтобы послушать',
      startLabel: 'С какого места', startHint: 'Двигайте ленту — гости услышат песню отсюда',
      playFrom: 'Слушать отсюда',
      top: 'Чаще берут с', startSlider: 'Начало песни',
      nudge: (d) => `На ${Math.abs(d)} с ${d < 0 ? 'раньше' : 'позже'}`, waveCooking: 'Читаем песню',
      startsAt: (time) => `Начнётся с ${time}`, fromStart: 'Играет с начала',
      chosen: 'Ваша песня', change: 'Выбрать другую', remove: 'Убрать музыку',
      skip: 'Продолжить без музыки',
      topTitle: 'Чаще всего выбирают', topText: 'Песни, которые пары ставят в приглашения',
      uses: (n) => `выбрали ${n} ${n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 12 || n % 100 > 14) ? 'раза' : 'раз'}`,
      magicTitle: 'Достать по ссылке', magicText: 'Вставьте ссылку на YouTube, TikTok, Instagram или другой сайт — музыку достанем сами',
      linkPh: 'Вставьте ссылку', paste: 'Вставить', importGo: 'Достать', importOff: 'Сейчас не работает',
      ...
      errors: {
        link: 'Ссылка не прочиталась', unsupported: 'С этого сайта звук не достать',
        ...
        noaudio: 'В этом видео нет звука', format: 'Этот файл не прочитался', timeout: 'Слишком долго — попробуйте ещё раз',
        busy: 'Сейчас большая очередь — попробуйте чуть позже', unavailable: 'Сейчас не работает', auth: 'Откройте студию через бота',
        failed: 'Музыку достать не вышло',
      },
    },
  };
